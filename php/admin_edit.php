      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
			...
			<form action="adminadd.php?exid=<?php echo $exid;?>" method="post">
			...
			<!--<div class="box-body form-group has-feedback">-->
              ...
              <strong><i class="fa fa-book margin-r-5"></i> Question</strong>

			  <p>
              <input type="text" class="form-control" id="eques" name="eques" value="">
              </input>
			  </p>

              <hr>

              <strong><i class="fa fa-map-marker margin-r-5"></i> Option A</strong>

              <p>
              <input type="text" class="form-control" id="eopa" name="eopa" value="">
              </input>
			  </p>

			  <hr>

			  <strong><i class="fa fa-map-marker margin-r-5"></i> Option B</strong>

              <p>
              <input type="text" class="form-control" id="eopb" name="eopb" value="">
              </input>
			  </p>

			  <hr>

			  <strong><i class="fa fa-map-marker margin-r-5"></i> Option C</strong>

              <p>
              <input type="text" class="form-control" id="eopc" name="eopc" value="">
              </input>
			  </p>

			  <hr>

			  <strong><i class="fa fa-map-marker margin-r-5"></i> Option D</strong>

              <p>
              <input type="text" class="form-control" id="eopd" name="eopd" value="">
              </input>
			  </p>

			  <hr>

			  <strong><i class="fa fa-map-marker margin-r-5"></i> Correct Answer</strong>

              <p>
              <input type="text" class="form-control" id="eans" name="eans" value="">
              </input>
			  </p>

			  <hr>

			  <strong><i class="fa fa-map-marker margin-r-5"></i> Marks</strong>

              <p>
              <input type="text" class="form-control" id="emark" name="emark" value="">
              </input>
			  </p>
			  ...
			  <div class="row">
				...
				<div class="col-xs-4">
				<input type="submit" value="Update" class="btn btn-primary btn-block btn-flat"></input>
				</div>
			  </div>
