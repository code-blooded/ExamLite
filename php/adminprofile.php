...
<head>
  ...
  <title>ExamLiTE | Admin Profile</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<ol class="content-header">
			<h4><a href="../php/adminprofile.php"></i>Home</a></h4>
		</ol>
		<div class="row">
        <div class="col-md-3">
				...
				<div id="upcoming" class="active tab-pane">
					...
					<ul class="list-group list-group-unbordered">
						<?php
							...
							mysqli_select_db($conn,"login");
							$result = mysqli_query($conn,"SELECT `id`, `name`, `date`, `end` FROM `exam`");
							mysqli_close($conn);
							if(!$result){
								echo "
								<script language='javascript'>
						...
						?>
							<li class="list-group-item">
								...
								<div class="col-md-2 right" style="text-align:right;"><a href="admin_edit.php?exid=<?php echo $rows["id"];?>" class="">Add Questions</a></div>
								<div class="col-md-1"></div>
								<div class="col-md-2 right" style="text-align:right;"><a href="admin_del.php?exid=<?php echo $rows["id"];?>" class="">Delete Questions</a></div>
								<div class="col-md-1"></div>
								<div class="col-md-2 right" style="text-align:right;"><a href="adminview_sol.php?exid=<?php echo $rows["id"];?>" class="">View Solution</a></div>
								</div>
							</li>
						<?php
							}
					...
					<ul class="list-group list-group-unbordered">
						...
						?>
							<li class="list-group-item">
								...
								<div class="col-md-2 right" style="text-align:right;"><a href="adminscore.php?exid=<?php echo $rows["id"];?>" class="">View Details</a></div>
								<div class="col-md-1"></div>
								<div class="col-md-2 right" style="text-align:right;"><a href="adminview_sol.php?exid=<?php echo $rows["id"];?>" class="">View Solution</a></div>
								</div>
							</li>
