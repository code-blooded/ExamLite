        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
		    ...
		    <div class="box-body form-group has-feedback">
			  ...
			  <strong><i class="fa fa-user margin-r-5"></i> Update Profile Pic</strong>
			  ...
			  <form action="upload.php" method="post" enctype="multipart/form-data">
				...
				<p>
				  <div class="row">
					...
					<div class="col-xs-4">
					<input type="submit" value="Upload Image" name="submit" class="btn btn-primary btn-block btn-flat"></input>
					</div>
				  </div>
				</p>
			  </form>
			...
			<!--<div class="box-body form-group has-feedback">-->
			  ...
			  <p>
              <input type="text" class="form-control" id="ename" name="ename" value="<?php echo $fname;?>">
              </input>
			  </p>
			  ...
			  <p>
              <input type="text" class="form-control" id="eeducation" name="eeducation" value="<?php echo $education;?>">
              </input>
			  </p>
              ...
              <p>
              <input type="text" class="form-control" id="eloc" name="eloc" value="<?php echo $loc;?>">
              </input>
			  </p>
			  ...
			  <p>
              <input type="text" class="form-control" id="ephone" name="ephone" value="<?php
				  if($phone)
				  echo $phone;
				  else
				  echo "**********";
              ...
              <p>
              <input type="text" class="form-control" id="estatus" name="estatus" value="<?php echo $status;?>">
              </input>
			  </p>
